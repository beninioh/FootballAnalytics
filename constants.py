...
GAMES_ATTRIB = ['id_home', 'id_away', 'home', 'away', 'h_formation', 'a_formation', 'h_yellow_cards',
                'h_yellow/red_cards', 'h_red_cards', 'h_goals', 'h_assists', 'h_secondary_assists',
                'h_assists_from_open_play', 'h_assists_from_set_play', 'h_shots', 'h_shots_on_goal',
                'h_interceptions', 'h_crosses', 'h_accurate_crosses', 'h_chances_created', 'h_big_chances_created',
                ...
                'h_free_kick_goals', 'h_goals_conceded', 'h_clean_sheets', 'h_saves', 'h_saves_from_shots_inside_box',
                ...
                'h_big_chance_missed', 'h_big_chance_scored', 'h_attempted_dribbles', 'a_yellow_cards',
                ...
                'a_free_kick_goals', 'a_goals_conceded', 'a_clean_sheets', 'a_saves', 'a_saves_from_shots_inside_box',
                ...
                'a_big_chance_missed', 'a_big_chance_scored', 'a_attempted_dribbles', 'week', 'nb_home', 'nb_away',
                'h_%_goals_inside', 'a_%_goals_inside', 'h_%_goals_outside', 'a_%_goals_outside', 'h_%_goals_free_kick',
                'a_%_goals_free_kick', 'h_%_goals_shot', 'a_%_goals_shot', 'h_%_goals_shot_on', 'a_%_goals_shot_on',
                'h_%_shot_shot_on', 'a_%_shot_shot_on', 'h_%_goals_shot_inside', 'a_%_goals_shot_inside',
                'h_%_shot_shot_inside', 'a_%_shot_shot_inside', 'h_%_goals_shot_on_inside', 'a_%_goals_shot_on_inside',
                'h_%_shot_shot_on_inside', 'a_%_shot_shot_on_inside', 'h_%_goals_shot_outside',
                'a_%_goals_shot_outside', 'h_%_shot_shot_outside', 'a_%_shot_shot_outside', 'h_%_goals_shot_on_outside',
                'a_%_goals_shot_on_outside', 'h_%_shot_shot_on_outside', 'a_%_shot_shot_on_outside',
                'h_%_assists_open_play', 'a_%_assists_open_play', 'h_%_assists_set_play', 'a_%_assists_set_play',
                'h_%_goals_chances', 'a_%_goals_chances', 'h_%_goals_big_chances', 'a_%_goals_big_chances',
                'h_%_chances_open_play', 'a_%_chances_open_play', 'h_%_chances_set_play', 'a_%_chances_set_play',
                'h_%_big_chances_missed', 'a_%_big_chances_missed', 'h_%_big_chances_scored', 'a_%_big_chances_scored',
                'h_%_touches_in_box', 'a_%_touches_in_box', 'h_%_passes_attempted', 'a_%_passes_attempted',
                'h_%_passes_long_balls', 'a_%_passes_long_balls', 'h_%_passes_through_balls',
                'a_%_passes_through_balls', 'h_%_crosses_accurate', 'a_%_crosses_accurate', 'h_%_dribbles_accurate',
                'a_%_dribbles_accurate', 'h_%_touches_dispossessed', 'a_%_touches_dispossessed',
                'h_%_fouls_yellow_cards', 'a_%_fouls_yellow_cards']
